...
func main() {
	...
	protected.Use(handler.AuthRequired())
	{
		...
		// Member routes — order matters: static paths before :id
		...
		// Product routes — order matters: static paths before :id
		...
		// Order & Cart routes — static paths before :id
		...
		// Loan routes — static paths before :id
